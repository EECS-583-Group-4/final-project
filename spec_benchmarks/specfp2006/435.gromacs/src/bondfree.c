/*
 * $Id: bondfree.c,v 1.1 2007/01/25 17:23:14 mchu Exp $
 * 
 ...
 */
static char *SRCID_bondfree_c = "$Id: bondfree.c,v 1.1 2007/01/25 17:23:14 mchu Exp $";
#include <math.h>
#include "assert.h"
#include "physics.h"
#include "vec.h"
