/*
 * $Id: relax_sh.c,v 1.1 2007/01/25 17:23:14 mchu Exp $
 * 
 ...
 */
static char *SRCID_relax_sh_c = "$Id: relax_sh.c,v 1.1 2007/01/25 17:23:14 mchu Exp $";
#include <string.h>
#include "assert.h"
#include "typedefs.h"
#include "smalloc.h"
...
#define  Try (1-Min)             /* At start Try = 1 */
  ...
  if (bFirst) {
    ...
    if (fabs(fr->fc_stepsize) > GMX_REAL_MIN)
