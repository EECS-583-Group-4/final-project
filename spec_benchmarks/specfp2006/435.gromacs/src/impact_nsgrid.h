/*
 * $Id: impact_nsgrid.h,v 1.1 2007/01/25 17:23:14 mchu Exp $
 * 
...
/* IMPACT_FIX
 * filename changed to avoid name conflict after flattening 
 * source directory -- impact_ was appended to original filename */
