/*
 * $Id: csettle.c,v 1.1 2007/01/25 17:23:14 mchu Exp $
 * 
 ...
 */
static char *SRCID_csettle_c = "$Id: csettle.c,v 1.1 2007/01/25 17:23:14 mchu Exp $";
...
#if !defined(SPEC_CPU) && defined(PRAGMAS)
#pragma ivdep
#endif
  for (i = 0; i < nshake; ++i) {
    /*    --- Step1  A1' ---      */
