/*
 * $Id: pbc.c,v 1.1 2007/01/25 17:23:14 mchu Exp $
 * 
 ...
 */
static char *SRCID_pbc_c = "$Id: pbc.c,v 1.1 2007/01/25 17:23:14 mchu Exp $";
#include <math.h>
#include "sysstuff.h"
#include "typedefs.h"
#include "vec.h"
...
char *check_box(matrix box)
{
  ...
  if (fabs(box[XX][YY])>GMX_REAL_MIN || fabs(box[XX][ZZ])>GMX_REAL_MIN || fabs(box[YY][ZZ])>GMX_REAL_MIN)
